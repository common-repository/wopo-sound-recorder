...
Tags: sound, recorder, wopo, wopo sound recorder, web-app, online, app, html5, javascript,
...
You can add shortcode [wopo-sound-recorder] to page you want to show app windows

== Installation ==

1. Upload the plugin files to the `/wp-content/plugins/wopo-sound-recorder` directory, or install the plugin through the WordPress plugins screen directly.
1. Activate the plugin through the 'Plugins' screen in WordPress
1. Add shortcode [wopo-sound-recorder] to page you want to show app windows
